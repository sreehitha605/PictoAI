...
const Login = () => {
        ...
        try {
            ...
            if(state === 'Login'){
                ...
                if(data.success){
                    ...
                    //if data is not success, then display the message in toast notification
    ...
    //to stop scrolling or disable the scrolling
    useEffect(()=>{
    ...
    bg-black/30 flex justify-center items-center'>
        ...
        className='relative bg-white p-10 rounded-xl text-slate-500'>
            ...
            {state !== 'Login' && <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                <img className='color-gray h-6' src={assets.profile_icon} alt="" />
